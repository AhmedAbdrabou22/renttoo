    ...
    <div className="ps-section--vendor ps-vendor-milestone">
        <div className="container">
            <div className="ps-section__header">
                <p>How it works</p>
                <h4>
                    Easy to start selling online on Renttoo just 4 simple steps
                </h4>
            </div>
                ...
                <div className="ps-block--vendor-milestone">
                    <div className="ps-block__left">
                        ...
                        <ul>
                            ...
                            <li>
                                Our Renttoo Advisors will help you at every step
                                and fully assist you in taking your business
                                online
                            </li>
                        </ul>
                    </div>
